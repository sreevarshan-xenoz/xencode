...
At its core is a fast, single-file **Rust** binary (14 crates, 714 tests,
...
```bash
cd rust
cargo test                          # Full workspace suite (714 tests)

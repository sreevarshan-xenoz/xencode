...
At its core is a fast, single-file **Rust** binary (13 crates, 641 tests,
...
```bash
cd rust
cargo test                          # Full workspace suite (641 tests)

...
from ..advanced_cache_system import CacheEntry, HybridCacheManager
from ..models.code_analysis import CodeAnalysisResult
from ..models.document import DocumentType, ProcessedDocument
from ..models.workspace import Change
...
class DocumentProcessingCache:
    ...
    async def invalidate_document_cache(self, file_path: str) -> int:
        ...
        for key, _hash_val in list(self.document_hashes.items()):

...
class DashboardRenderer:
    ...
    def create_resource_utilization_panel(self) -> Panel:
        ...
        progress.add_task("CPU", total=100, completed=metrics.get('cpu_usage', 0))
        progress.add_task("Memory", total=100, completed=metrics.get('memory_usage', 0))
        progress.add_task("Disk", total=100, completed=metrics.get('disk_usage', 0))

...
from .system.debugging_manager import (
    debug_function,
    get_debugging_manager,
    trace_function,
)
from .system.robustness_manager import RobustWarpTerminal
from .system.session_manager import cleanup_on_exit, get_session_manager
            ...
            while self.running:
                try:
                    ...
                    if command.lower() in ["exit", "quit"]:
                        ...
                        if selected_command:
                            self.terminal.run_command(selected_command)
                        ...
                        with Progress(
                            ...
                            progress.add_task(f"Running: {command}...", total=None)

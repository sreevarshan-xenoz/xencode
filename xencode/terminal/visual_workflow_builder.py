...
from ..cache.advanced_memory_manager import get_memory_manager
...
class InputNodeProcessor(NodeProcessor):
    ...
    async def process(self, node: WorkflowNode, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        node.config.get("prompt", "Enter input:")
...
class VisualWorkflowInterface:
    ...
    async def _connect_nodes_interactive(self):
        ...
        self.builder.connect_nodes(source_node.id, target_node.id, conn_type, label)
    ...
    def _view_templates(self):
        ...
        categories = {template.category for template in self.builder.templates}
...
if __name__ == "__main__":
    ...
    if "--interactive" in sys.argv:
        ...
        async def test_visual_workflow_builder():
            ...
            vwb.builder.visualize_workflow()

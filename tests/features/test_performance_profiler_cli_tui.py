...
class TestTUIComponents:
    ...
    def test_bottleneck_visualization_creation(self):
        ...
        from xencode.tui.widgets.performance_profiler_panel import BottleneckVisualization
    ...
    def test_optimization_suggestions_creation(self):
        ...
        from xencode.tui.widgets.performance_profiler_panel import OptimizationSuggestions
